...
function ExperienceItem({ job, isFirst, isLast, currentLabel, lang }) {
  ...
  return (
    <Reveal className={`relative pl-[30px] ${isLast ? '' : 'pb-[38px]'}`}>
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        <h3
          className="m-0 font-display font-semibold text-[#f1f5f9]"
      ...
      <p className="mt-1.5 font-mono text-[13px] text-[#60a5fa]">{job.company}</p>
      <p
        ref={ref}
