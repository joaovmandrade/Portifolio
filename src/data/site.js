...
export const skillGroups = [
  {
    id: 'frontend',
    label: 'Frontend',
    items: ['React', 'HTML', 'CSS', 'JS', 'Tailwind', 'Vite', 'Bootstrap'],
  },
  {
    id: 'mobile',
    label: 'Mobile',
    items: ['React Native', 'Flutter (em aprendizado)', 'PWA'],
  },
  {
    id: 'backend',
    label: 'Backend',
  ...
  },
  {
    id: 'tools',
    label: 'Ferramentas',
    items: ['Git', 'GitHub', 'VS Code', 'Cursor', 'Figma'],
  },
  {
    id: 'methods',
    label: 'Metodologias',
    items: ['Scrum', 'Clean Code'],
  },
]
